...
TWILIO_SID="${TWILIO_SID:-ACxxxxxxxxxxxxxxxxxxxxxxxxxxxxx}"
TWILIO_TOKEN="${TWILIO_TOKEN:-e616af73ddcf205b39f35f918d5cda49}"
TWILIO_NUMBER="${TWILIO_NUMBER:-+13464894281}"
SENDGRID_KEY="${SENDGRID_KEY:-SG.xxxxxxxxxxxxxxxxxxxxxxxxxxxxx}"
OPENAI_KEY="${OPENAI_KEY:-sk-proj-xxxxxxxxxxxxxxxxxxxxxxxxxxxx}"
AWS_KEY_ID="${AWS_KEY_ID:-AKIAxxxxxxxxxxxxxxxxxxxxxxxx}"
AWS_SECRET="${AWS_SECRET:-xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx}"
